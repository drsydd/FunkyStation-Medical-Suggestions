...
3) Instead of family medical history (useless gameplay wise), maybe change to personal medical history ? If patient has migraines, not taken betablockers will lead to headaches. If patient has chronic heart failure, not taking them will lead to acute heart failure. If patient has essential tremor (NEW), not taking them leads to hands shaking and dropping items on the floor regularly. 

4) Some players should spawn without their meds (people often couldn't get an appointment fast enough to renew them, or forget them when travelling). This would lead to more early round gameplay for medical with a few patients coming in to renew their prescriptions (RP).

5) All of the above extends the medical gameplay on what has already been put in the customization screen, but is unique compared to the basic 4 or 5 type of damages already in the game.
These conditions are another layer that can sometimes add damage if left untreated, or crit patients depending on their severity.

6) Would lead to interesting RP with CMO doing rounds for interns?
